...
public class BookingPanel extends JPanel {
    ...
    public BookingPanel(MainFrame frame) {
        ...
        // Eğer liste boşsa kullanıcıya uyarı 
        if (filteredList.isEmpty()) {
            JOptionPane.showMessageDialog(this, 
            "Aradiginiz kriterlere uygun ucus bulunamadi.", 
            "Sonuc Yok", 
    ...
    private void initiateBookingProcess(Seat seat, JButton btn) {
        ...
        if (option == JOptionPane.OK_OPTION) {
            try {
                ...
                String bagageText = txtBagage.getText().trim();

                
                if (id.isEmpty() || name.isEmpty() || bagageText.isEmpty()) {
                ...
                int bagage = Integer.parseInt(bagageText);
                ...
                if (bagage > bagageLimit) {
                    int extra = bagage - bagageLimit;
                    int extraFee = extra * 50;
                    totalPrice += extraFee;
                }
                // guncel tutar gorunteleme
                String confirmMsg = "Bilet Tutari: " + basePrice + " TL\n" +
                        "Bagaj (" + bagage + " kg): " + (totalPrice - basePrice) + " TL Ekstra\n" +
                        "--------------------------\n" +
                ...
                if (paymentOption == JOptionPane.YES_OPTION) {
                    ...
                    reservationManager.makeReservation(resCode, selectedFlight, seat, passenger, bagage);
