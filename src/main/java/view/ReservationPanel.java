...
public class ReservationPanel extends JPanel {
    ...
    private void queryReservation(String code) {
        ...
        if (currentFoundReservation != null) {
            ...
            info.append("Bagaj            : ").append(currentFoundReservation.getBagage()).append(" kg\n");
            info.append("Odenen Tutari    : ").append(calculator.calculateTotalPrice(currentFoundReservation.getSeat().getSeatClass(), currentFoundReservation.getBagage() )).append(" TL\n");
