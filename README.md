...
Bu proje, bir havayolu şirketinin temel operasyonlarını yönetmek için tasarlanmış, **Nesne Yönelimli Programlama (OOP)** prensiplerine dayalı bir Java uygulamasıdır. 
...
* **Personel Takibi:** Havayolu çalışanlarının (pilot, kabin memuru vb.) sistem üzerinden yönetimi.
